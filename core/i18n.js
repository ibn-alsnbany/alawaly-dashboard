const translations = {
    ar: {
        ...
        // Inventory specific
        inventory: "المخزون",
        inventorySubtitle: "مراقبة حركات المستودع وتدفق المنتجات.",
        stockMovements: "حركات المخزون",
        stockLevel: "مستوى المخزون",
        recentMovements: "آخر التحركات",
        stockArrival: "توريد مخزني",
        saleOrder: "أمر بيع",
        internalUse: "استخدام داخلي",
        bulkPurchase: "شراء كميات",
        reason: "السبب",
        type: "النوع",
        quantity: "الكمية",
        movementIn: "وارد",
    ...
    en: {
        ...
        // Inventory specific
        inventory: "Inventory",
        inventorySubtitle: "Monitor warehouse movements and product flow.",
